...
//       if (premiumDuration !== 1 && premiumDuration !== 4 && premiumDuration !== "1" && premiumDuration !== "4") {
//         return res.status(400).json({
...
//       const newPremiumExpiresAt = new Date(Date.UTC(
//         now.getUTCFullYear(),
...
//     console.error("Error updating user role:", error);
//     return res.status(500).json({
//       message: locale === "es" ? "Error al actualizar el rol." : "Error updating role."
//     });
//   }
// }
