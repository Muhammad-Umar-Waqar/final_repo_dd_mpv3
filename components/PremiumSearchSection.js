...
// // const PremiumSearchSection = ({ showFilterButton = true, isLoading = false, autoFocus = false, showCategories=true }) => {
...
//   // Choose which filter list to render based on showFilterButton
...
//           domain: cat.id,
//           // If you want to use the translation function on the label,
