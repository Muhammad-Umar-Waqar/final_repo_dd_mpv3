...
// const BasicSearchSection = ({ showFilterButton = true, isLoading = false, autoFocus = false, showCategories=true }) => {
...
//       <p className="mb-4">
//         {locale === 'en' ? "Unlock Advanced Search Using Premium" : "Desbloquea la Búsqueda Avanzada con Premium"}
//       </p>
//       <button
...
//     <div className="bg-white p-4 rounded shadow-md max-w-xs text-center">
//       <p className="mb-4">
//         {locale === 'en' ? "Unlock Advanced Filter Section Using Premium" : "Desbloquear sección de filtro avanzado con Premium"}
//       </p>
//       <button
//         onClick={() => router.push('/premium')}
//         className="bg-primary text-white px-4 py-2 rounded hover:bg-primary/90 transition-colors"
...
//   // Assume premium status is stored in session.user.isPremium
...
//   // Modified handleFilterClick to show the premium popup if not premium
...
//                 >
//                   {t(filter.labelKey)}
//                   {/* Show a lock icon for non-premium users */}
//                 </button>
//               );
//             })
//           : (
...
//       {showPremiumFilter && <PremiumPopupFilterSection onClose={() => setshowPremiumFilter(false)} />}
//     </>
//   );
// };
...
// Mar, 26 Commenting for Changing Categories of articles
