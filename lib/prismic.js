...
// prismic.js
export async function getAllBlogCategories(lang = 'en-us') {
  // Replace 'category' with your actual custom type name if different
  return await client.getAllByType('category', {
    lang,
    orderings: {
      field: 'my.category.title',  // adjust to match your field structure
      direction: 'asc'
    },
  });
}
